...
export async function askVoiceAssistant(prompt) {
  ...
  const completion = await groq.chat.completions.create({
    messages: [
      {
        role: "system",
        content: "You are an agricultural voice assistant. Respond clearly and concisely in a friendly manner. Provide practical advice for farmers in India. DO NOT output any markdown, formatting, or internal thoughts. Give only the final answer in a conversational tone."
      },
      {
        role: "user",
        content: prompt
  ...
  // Clean up any potential markdown that might affect text-to-speech
