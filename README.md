<div align="center">
  ...
  <p><b>Empowering Farmers with AI-Driven Intelligence</b></p>
...
- 🐛 **Pesticide Predictor**: Intelligent diagnosis of crop diseases with highly accurate, targeted pesticide recommendations.
...
- 🌍 **Multilingual Support**: Fully localized in English, Hindi, Bengali, Tamil, and Telugu to reach farmers in their native tongue.
...
| --- | --- |
| **Frontend** | React.js, Tailwind CSS, Capacitor (for cross-platform mobile support) |
| **Backend** | Node.js, Express.js |
| **Database** | MongoDB |
| **AI/ML Integration** | Generative AI / Groq SDK for smart predictions |
| **Infrastructure** | PWA Ready (Works offline and installs natively on devices via Service Workers) |
...
npm start
```
The React frontend will be running locally at `http://localhost:3000`.

### 3. Backend Setup
Open a new terminal window/tab, navigate to the backend folder, and start the API server:
```bash
cd backend
npm install
npm start
